...
@Test
public class TC_15 extends BaseClass1 {
	public void purchase4() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='qty1']")).sendKeys("023");// All mandatory field
